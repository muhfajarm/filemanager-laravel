<footer class="bg-white dark:bg-gray-800">
  <div class="container px-6 py-4 mx-auto">
    <div class="lg:flex">
      <div class="w-full lg:w-2/5 flex justify-center">
        <div class="px-6">
          <div class="flex justify-center">
            <a href="#">
              <x-guest.logo class="w-[100px] h-[100px]" />
            </a>
          </div>

          <p class="max-w-md mt-2 text-gray-500 dark:text-gray-400">12 Years Full of Passion</p>

          <div class="flex mt-4 -mx-2 justify-center">
            ...
            <a href="#" class="mx-2 text-gray-700 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400" aria-label="Instagram">
              <svg class="w-4 h-4 fill-current" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="#" class="mx-2 text-gray-700 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400" aria-label="YouTube">
              <svg class="w-4 h-4 fill-current" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="mt-6 lg:mt-0 lg:flex-1">
        <div class="grid grid-cols-1 gap-6 md:grid-cols-3 md:justify-items-center">
          <div>
            <h3 class="text-gray-700 uppercase dark:text-white">Hubungi Kami</h3>
  ...
  <hr class="h-px bg-gray-300 border-none dark:bg-gray-700">

  <div class="flex justify-center items-center py-2">
    <p class="text-xs text-center text-gray-800 dark:text-white">MqD © {{ config('app.name', 'LPMI -  - STIKES Guna Bangsa Yogyakarta') }}</p>
  </div>
