      ...
      <div x-data="{ openTab: 'criteria 1' }">
                ...
                <div class="p-4 bg-gray-100 rounded-lg dark:bg-gray-800" x-data="{selected:null}">
                  ...
                  <div class="relative overflow-hidden transition-all max-h-0 duration-700" style="" x-ref="container1" :style="selected == 1 ? 'max-height: ' + $refs.container1.scrollHeight + 'px !important' : ''">
                    <div class="mt-6 text-sm text-gray-500 dark:text-gray-300 px-4">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus quis in ut ducimus repudiandae, perspiciatis reprehenderit quasi similique consequuntur veniam sunt atque. Enim sed nemo fugit magnam. Beatae, illo enim. Officiis velit omnis atque! Dolores qui eius mollitia quidem, unde dignissimos doloribus excepturi ullam temporibus nisi? Placeat animi aperiam vitae.
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="w-full px-4">
          <div x-show="openTab === 'criteria 2'">
            <div class="w-full">
              <h3 class="text-xl font-semibold text-gray-800 dark:text-white">Tata Pamong</h3>

              <div class="space-y-8 my-4">
                <div class="p-4 bg-gray-100 rounded-lg dark:bg-gray-800" x-data="{selected:null}">
                  <button type="button" class="flex items-center justify-between w-full text-left" @click="selected !== 1 ? selected = 1 : selected = null">
                    <span class="text-blue-600">
                      <a href="{{ asset('storage/LPMI/AMI Tahun 2018/AMI TAHUN 2018.pdf') }}" target="_blank()" class="dark:text-gray-100">Tata Pamong</a>
                    </span>
                    <span class="rounded-full transition-all duration-700" :class="selected==1 ? 'text-gray-700 bg-gray-200' : 'text-white bg-blue-500'">
                      <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 12H6" :d="selected == 1 ? 'M18 12H6': 'M12 6v6m0 0v6m0-6h6m-6 0H6'" />
              ...
              <h3 class="text-xl font-semibold text-gray-800 dark:text-white">Tata Kelola</h3>

              <div class="space-y-8 my-4">
                <div class="p-4 bg-gray-100 rounded-lg dark:bg-gray-800" x-data="{selected:null}">
                  <button type="button" class="flex items-center justify-between w-full text-left" @click="selected !== 1 ? selected = 1 : selected = null">
                    <span class="text-blue-600">
                      <a href="{{ asset('storage/LPMI/AMI Tahun 2018/AMI TAHUN 2018.pdf') }}" target="_blank()" class="dark:text-gray-100">Tata Kelola</a>
                    </span>
                    <span class="rounded-full transition-all duration-700" :class="selected==1 ? 'text-gray-700 bg-gray-200' : 'text-white bg-blue-500'">
                      <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 12H6" :d="selected == 1 ? 'M18 12H6': 'M12 6v6m0 0v6m0-6h6m-6 0H6'" />
              ...
              <h3 class="text-xl font-semibold text-gray-800 dark:text-white">Kerjasama</h3>

              <div class="space-y-8 my-4">
                <div class="p-4 bg-gray-100 rounded-lg dark:bg-gray-800" x-data="{selected:null}">
                  <button type="button" class="flex items-center justify-between w-full text-left" @click="selected !== 1 ? selected = 1 : selected = null">
                    <span class="text-blue-600">
                      <a href="{{ asset('storage/LPMI/AMI Tahun 2018/AMI TAHUN 2018.pdf') }}" target="_blank()" class="dark:text-gray-100">Kerjasama</a>
                    </span>
                    <span class="rounded-full transition-all duration-700" :class="selected==1 ? 'text-gray-700 bg-gray-200' : 'text-white bg-blue-500'">
                      <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 12H6" :d="selected == 1 ? 'M18 12H6': 'M12 6v6m0 0v6m0-6h6m-6 0H6'" />
        ...
        <div class="w-full px-4">
          <div x-show="openTab === 'criteria 3'">
            <h3 class="text-xl font-semibold text-gray-800 dark:text-white">Mahasiswa</h3>

            <div class="space-y-8 my-4">
              <div class="p-4 bg-gray-100 rounded-lg dark:bg-gray-800" x-data="{selected:null}">
                <button type="button" class="flex items-center justify-between w-full text-left" @click="selected !== 1 ? selected = 1 : selected = null">
                  <span class="text-blue-600">
                    <a href="{{ asset('storage/LPMI/AMI Tahun 2018/AMI TAHUN 2018.pdf') }}" target="_blank()" class="dark:text-gray-100">Mahasiswa</a>
                  </span>
                  <span class="rounded-full transition-all duration-700" :class="selected==1 ? 'text-gray-700 bg-gray-200' : 'text-white bg-blue-500'">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 12H6" :d="selected == 1 ? 'M18 12H6': 'M12 6v6m0 0v6m0-6h6m-6 0H6'" />
